 ...
 *    (needed for auto-generating UUID values automatically).
 * 2. Creates the "Users" table with proper constraints, defaults, and validations.
 * 3. Creates a down method to revert changes (drop the table and extension).
 */
...
module.exports = {
  ...
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.createTable("Users", {
      ...
      role: {
        type: Sequelize.ENUM("admin", "patient", "doctor"), // Restrict roles to defined values
        allowNull: false,

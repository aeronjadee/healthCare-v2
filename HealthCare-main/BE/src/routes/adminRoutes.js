 ...
 * - Provides endpoints for dashboard data, user management, and appointment management
 */
 ...
 * @desc    Create a new doctor or patient account
 * @access  Private (Admin only)
 */
 ...
 * @desc    Retrieve all appointments (with patient & doctor info)
 * @access  Private (Admin only)
 */
